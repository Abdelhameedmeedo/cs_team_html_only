...
//open paied-books description
let paied_books_desc = document.querySelectorAll('.paied-books .list-items h3')
paied_books_desc.forEach(el=>{
  el.addEventListener('click',e=>{
   console.log( e.target.innerHTML)
   window.location.href = '../html/paied_books.html'
  })
})
//open profile
